...
public class FileUtils {
    ...
    public static String readFromRaw(int rawId) {
        InputStream inputStream = GLApplication.getContext().getResources().openRawResource(rawId);
    ...
    public static int getDimensionPixel(@DimenRes int id) {
        return GLApplication.getContext().getResources().getDimensionPixelSize(id);
    }
