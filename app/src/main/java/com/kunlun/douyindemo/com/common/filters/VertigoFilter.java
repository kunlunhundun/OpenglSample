package com.kunlun.douyindemo.com.common.filters;
...
import com.kunlun.douyindemo.com.common.glutil.RenderBuffer;
...
public class VertigoFilter extends ImageFilter {
    ...
    public void draw(int textureId, float[] texMatrix, int canvasWidth, int canvasHeight) {
        if (mRenderBuffer == null) {
            ...
            android.opengl.GLUtils.texImage2D(GL_TEXTURE_2D, 0, BitmapFactory.decodeResource(GLApplication.getContext().getResources(), R.raw.lookup_vertigo), 0);
        }
        mRenderBuffer.bind();
