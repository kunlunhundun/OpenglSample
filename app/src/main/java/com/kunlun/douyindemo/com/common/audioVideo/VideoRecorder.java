...
import com.kunlun.douyindemo.com.common.audioVideo.offscreen.OffScreenWrapper;
...
public class VideoRecorder implements Recorder<VideoConfig> {
    ...
    public void prepareCodec() throws IOException {
        MediaFormat format = MediaFormat.createVideoFormat(ConstAV.VideoParams.MIME_TYPE,
        ...
        format.setInteger(MediaFormat.KEY_FRAME_RATE, ConstAV.VideoParams.SAMPLE_RATE);
        format.setInteger(MediaFormat.KEY_I_FRAME_INTERVAL, ConstAV.VideoParams.I_FRAME_INTERVAL);
        encoder = MediaCodec.createEncoderByType(ConstAV.VideoParams.MIME_TYPE);
