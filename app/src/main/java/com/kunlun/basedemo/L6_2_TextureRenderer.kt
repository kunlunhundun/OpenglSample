...
import com.kunlun.basedemo.util.ProjectionMatrixHelper
...
class L6_2_TextureRenderer(context: Context) : BaseRenderer(context) {
    companion object {
        ...
        private val POINT_DATA3 = floatArrayOf(0f, 0f, 0f, 2f* 0.5f,  1f, 2f* 0.5f,  1f, 0f)
    ...
    private val mVertexData3: FloatBuffer;
    ...
    private var mTextureBean3: TextureHelper.TextureBean? = null
    ...
    init {
        ...
        mVertexData3 = BufferUtil.createFloatBuffer(POINT_DATA3);
    ...
    override fun onSurfaceCreated(glUnused: GL10, config: EGLConfig) {
        ...
        mTextureBean3 = TextureHelper.loadTexture(context, R.drawable.tuzki)
    ...
    override fun onDrawFrame(glUnused: GL10) {
        ...
        //  var bitmap = readPixel(mTextureBean!!.width,mTextureBean!!.height)
    ...
    private fun drawTuzki2() {
        mVertexData3.position(0)
        GLES20.glVertexAttribPointer(mAPositionLocation, POSITION_COMPONENT_COUNT,
                GLES20.GL_FLOAT, false, 0, mVertexData3)
        GLES20.glEnableVertexAttribArray(mAPositionLocation)

        // 绑定新的纹理ID到已激活的纹理单元上
        GLES20.glBindTexture(GLES20.GL_TEXTURE_2D, mTextureBean3!!.textureId)
        GLES20.glDrawArrays(GLES20.GL_TRIANGLE_FAN, 0, POINT_DATA.size / POSITION_COMPONENT_COUNT)
    }
}
